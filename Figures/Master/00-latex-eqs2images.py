...
## Settings
preamble = 'eqs-preamble.tex' # Name of file containing the preamble (just short of \begin{document})
src_fname = '../../equations.tex' # Path and filename of the source
dest = '../Extractions' # Destination directory
env_names = ['equation', 'subequations', 'multline'] # Names of LaTeX environments to look for (The starred versions will be searched as well.)
