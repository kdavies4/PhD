...
sim.plot(title="""Gas Velocity in Two Subregions\n""",
         label='Velocity',
...
sim.plot(title="""Gas Velocity in Two Subregions\n""",
         ...
         leg1_kwargs=dict(loc='upper right'), xunit='us')
plt.xlim([4.8, 7.8])
plt.ylim([15.8, 16.5])
save()
plt.close()
...
# Plot
sim.plot(title=r"""Pressure Dynamics of Gas in Two Subregions
$\zeta = 2.32\times10^{-5}$ N/A""",
         label='Pressure',
