...
variable = 'testConditions.anRH' # Varied parameter
...
multiplot(sims, xname='J', ynames1=['w'], label='Polarization',
          title = 'Cell Polarization: Varying Anode Inlet Humidity\n'
...
# Load the results.
runs = map(Results, ['090719-I111-60%-RH-An.csv',
                     '090718-I111-Baseline5.csv',
                     '090719-I111-100%-RH-An.csv'])
