...
vals = [sim.get_FV('testConditions.I_an')/sim.get_FV('zI') for sim in sims]
...
multiplot(sims, xname='J', ynames1=['w'], label='Polarization',
          title = 'Cell Polarization: Varying Anode Flow Rates\n'
...
# Load the results.
runs = map(Results, ['090717-I111-1.1-Stoich-H2.csv',
                     '090717-I111-Baseline3.csv',
                     '090717-I111-2.0-Stoich-H2.csv'])
